...
theme.start_icon                                = theme.dir .."/icons/pop-os.png"
...
function theme.at_screen_connect(s)
    ...
    mylauncher = awful.widget.launcher({ image = beautiful.start_icon,
                                     menu = {} })
